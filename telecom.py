...
def reception():
	message = radio.receive()
        if message :
            ...
            if listMessage[-1] == "fin":
                ...
                vit_x = int(listMessage[0]) #on découpe notre signal et on attribue les valeurs de vitesses
	...
	return vit_x,vit_y,vit_rot,tir,passe,dribble #on retourne un t-uple avec toutes les grandeurs
