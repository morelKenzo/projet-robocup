...
class Robot() :
    ...
    def __init__(self, idRobot=2, radioGroup=10) :
    ...
    def Decode_Message(self,msg_radio):
        DictDemande={180:'reset',181:'Tension'}
        ...
        if int.from_bytes(msg_radio[0:1],'big')==self.idRobot:
            ...
            if message ==20:
                ...
                #Calcul et retour des tensions à l'utilisateur
                list_Tension_V=self.Tension_robot()
                message_retour=str(list_Tension_V)
                radio.send(message_retour)


    def Tension_robot(self):
        #Mesure de la tension de tout les moteurs et calcul de la tension moyenne
        Tension_mot1=self.mot1.demandeTension()
        sleep(20)
        Tension_mot2=self.mot2.demandeTension()
        sleep(20)
        Tension_mot3=self.mot3.demandeTension()
        Tension_moyenne_V=(Tension_mot1+ Tension_mot2+Tension_mot3)/3
        return([Tension_mot1, Tension_mot2,Tension_mot3])
...
robot.mot1.setSpeedRotation(0)
robot.mot2.setSpeedRotation(0)
robot.mot3.setSpeedRotation(0)

while True:
    if button_a.is_pressed():
        display.show(Image.NO)
        robot.mot1.setSpeedRotation(512)
        sleep(1000)
        robot.mot1.setSpeedRotation(0)
        robot.mot2.setSpeedRotation(512)
        sleep(1000)
        robot.mot2.setSpeedRotation(0)
        robot.mot3.setSpeedRotation(512)
        sleep(1000)
        robot.mot3.setSpeedRotation(0)

    if button_b.is_pressed():
        list_Tension_V=robot.Tension_robot()
        message_retour=str(list_Tension_V)
        display.scroll(message_retour)
        #radio.send(message_retour)
